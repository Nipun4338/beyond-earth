...
function UpcomingCard(values) {
  ...
  return (
    <Card
      ...
      style={{ backgroundColor: "#0c0e10", color: "white" }}
    >
      <CardActionArea onClick={handleExpandClick}>
        <CardMedia component="img" image={values.values.image} alt="Launcher" />
        <CardContent>
          <Typography
            gutterBottom
            variant="h5"
            ...
            {mouse === true ? (
              <div>
                ...
                {values.values.vidURLs ? (
                  <div>
                    {values.values.vidURLs.map((link, index) => {
                      return (
